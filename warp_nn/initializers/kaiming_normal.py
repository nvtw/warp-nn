...
def kaiming_normal(
    ...
    *,
    ...
    r"""Initialize the array using the Kaiming (aka He) normal initialization method.

    .. math::

        x \leftarrow \mathcal{N}(0, b)
        \quad \text{where} \quad
    ...
    value = np.random.normal(0.0, bound, size=array.shape)
    if inplace:
